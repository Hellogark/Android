...
public class registroLocales extends AppCompatActivity implements View.OnClickListener{
                        ...
                        (registroLocales.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(!task.isSuccessful()){
                                    ...
                                    String direccion=dir.getText().toString(),categoria="";
                                    String tel2="", sWeb="",tel1="";
                                    int tipoLocal=0;
                                    ...
                                    String lunes="",martes="",miercoles="",jueves="",viernes="",
                                            sabado="",domingo="";
                                    String longitud =
                                            String.valueOf(m.getLocationFromAddress(contexto,direGeo).longitude);
                                    longitud=longitud.replace("\"","");
                                    String latitud =
                                            String.valueOf(m.getLocationFromAddress(contexto,direGeo).latitude);
                                    ...
                                    int tipoCuenta=Integer.parseInt(pktOb);
                                     ...
                                     insertarBd(nombre,mail,direccion,tel1,tel2,sWeb,tipoCuenta,
                                             tipoLocal,categoria,id_usuario,latitud,longitud,
    ...
    private void insertarBd(String nombre, String mail, String direccion,  String tel1, String tel2,
                            String sWeb, int tipoCuenta,int tipoLocal,String categoria, String id,
                            String lat,String longitud,String lunes,String martes,String miercoles,
        ...
        nuevoMapa.put("TipoLocal",tipoLocal);
        nuevoMapa.put("Categoria",categoria);
        ...
        dbUbi.setValue(mUbi);
        DatabaseReference dbHor = FirebaseDatabase.getInstance().getReference().child("Locales")
                .child(id).child("Horario");
        Map hora=new HashMap();
        hora.put("Lunes",lunes);
        hora.put("Martes",martes);
        hora.put("Miercoles",miercoles);
        hora.put("Jueves",jueves);
        hora.put("Viernes",viernes);
        hora.put("Sabado",sabado);
        hora.put("Domingo",domingo);
        dbHor.setValue(hora);
